...
public class DJJLHistoryAdapter extends BaseExpandableListAdapter {
    private Context context;
    private List<List<DjjlHistoryViw>> list_data;
    private List<Bk_ks> bk_ks;
    private List<Sfrz_rzjg> rzjg1, rzjg2;
    private Handler handler = new Handler();
    private String ccmc, kcmc;

    public DJJLHistoryAdapter(Context context, String kcmc, String ccmc, List<List<DjjlHistoryViw>> list_data) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (viewHolder == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.pad_adapter_djjl_history, null);
        ...
        viewHolder.mListItemHistoryYyz.setText(Integer.toString(list_data.get(groupPosition).get(childPosition).getDj_sl()));
        viewHolder.mListItemHistoryWyz.setText(Integer.toString(list_data.get(groupPosition).get(childPosition).getZc_sl()));
        ...
        viewHolder.mListItemPiechartHistory.setData(setPiechartData(list_data.get(groupPosition).get(childPosition).getDj_sl(), list_data.get(groupPosition).get(childPosition).getAll_sl()));
        return convertView;
    }
