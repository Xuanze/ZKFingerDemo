...
public class SettingDialog3 extends Dialog implements View.OnClickListener {
    ...
    public SettingDialog3(Context context, int themeResId, String content, OnCloseListener listener) {
    ...
    public SettingDialog3 setTitle(String title) {
        this.title = title;
        return this;
    }

    public SettingDialog3 setPositiveButton(String name) {
        this.positiveName = name;
        return this;
    }

    public SettingDialog3 setNegativeButton(String name) {
